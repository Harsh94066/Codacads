...
const C = () => {
    return (
        ...
        //         <li style={{ marginTop: "0.7rem", marginLeft: "1rem" }}><u><b>printf() function:</b></u>&nbsp;
        ...
        //         </li>
        //         <li style={{ marginTop: "0.7rem", marginLeft: "1rem" }}><u><b>scanf() function:</b></u>&nbsp;
        ...
        //       <ul>
        //         <li style={{ marginLeft: "1rem" }}><a href="https://www.javatpoint.com/constants-in-c" target="_blank"> C constants </a></li>
        //         <li style={{ marginLeft: "1rem" }}><a href="https://www.javatpoint.com/literals-in-c" target="_blank"> C literals </a></li>
        //         <li style={{ marginLeft: "1rem" }}><a href="https://www.javatpoint.com/static-in-c" target="_blank"> C static </a></li>
        //         <li style={{ marginLeft: "1rem" }}><a href="https://www.javatpoint.com/programming-errors-in-c" target="_blank"> C Programming errors </a> </li>
        //       </ul>
        //     </section>

        //     <section className="section">
        //       <h2> C Control Statement</h2>
        //       <p style={{ fontWeight: "bold", marginBottom: "0.2rem" }}>There are four types of control statements:</p>
        //       <ul style={{ marginBottom: "0.5rem" }}>
        //         <li style={{ marginLeft: "1rem" }}>Sequential control statements</li>
        //         <li style={{ marginLeft: "1rem" }}>Conditional/Decision control statements</li>
        //         <li style={{ marginLeft: "1rem" }}>Switch control statements</li>
        //         <li style={{ marginLeft: "1rem" }}>Looping control statements</li>
        //       </ul>
        ...
        //       </ul>
        //       <p style={{ marginTop: "-0.5rem" }}>For more understanding you can refer this <a href="https://www.javatpoint.com/functions-in-c" target="_blank">C Functions</a>
        //       </p>
        //     </section>
