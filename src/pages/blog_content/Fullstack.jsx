        ...
        <div>
            <div className="website_theme">
                ...
                <section className="fullstack-section">
                    ...
                    <h2 className="full-h2"> How to become a Full Stack Web Developer</h2>
                    <hr />
                    <ul>
                        <li>
                ...
                <section className="fullstack-section">
                    <h4 className="full-h4">The Bucket Technique</h4>
                    <hr />
                ...
                <section className="fullstack-section">
                    ...
                    <h2 className="full-h2">Recommended Common Skills </h2>
                    <hr />
                    <div className="tip">
                    ...
                    <section className="front_end">
                        <h5 className="full-h5">Bootstrap</h5>
                        <hr />
                    ...
                    <section className="front_end">
                        <h5 className="full-h5">React JS</h5>
                        <hr />
                        <p>
