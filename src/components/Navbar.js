            ...
            <div className="front-page">
                ...
                <div className="front-page-cards">
                    <div className="single-card">
                        <img src="https://cp.cyberlabs.club/img/undraw_solution_mindset.svg" alt="error" height="200" width="200" />
                    ...
                    <div className="single-card">
                        <img src="https://cp.cyberlabs.club/img/undraw_Process.svg" alt="error" height="200" width="200" />
                        <h4>Practice</h4>
