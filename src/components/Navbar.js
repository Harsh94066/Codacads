            ...
            <div className="front-page">
                ...
                <div className="front-page-cards">
                    <div className="single-card">
                        <img src="/images/Algorithm.jpg" alt="error" height="200" width="250" />
                    ...
                    <div className="single-card">
                        <img src="/images/Practice.jpg" alt="error" height="200" width="270" />
                        <h4>Practice</h4>
                    ...
                    <div className="single-card">
                        <img src="/images/Contest.jpg" alt="error" height="200" width="200" />
